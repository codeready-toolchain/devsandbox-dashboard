...
import { OpenClawWorkspace } from '../types';
...
/** Default workspace configuration for a new OpenClaw instance. */
...
/** Default skills for a new OpenClaw instance in Dev Sandbox. */
